...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="form-group offset-2 col-4">
            ...
            <label for="noTel" class="<?php //echo $classnoTel; ?>">Nom de la
                salle :</label>
    ...
    <div class="row">
        <div class="form-group offset-2 col-4">
            ...
            <label for="noTel" class="<?php //echo $classnoTel; ?>">Activité
                :</label>
        ...
        <div class="col-2">
            ...
            <label for="travaux" class="<?php //echo $classnoTel; ?>">Prénom
                formateur :</label>
            <input type="text" class="form-control" name="travaux" id="travaux"
                   required>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        ...
        <div class="form-group col-2">
            ...
            <label for="precisActivite" class="<?php //echo $classnoTel; ?>">Précision
                sur activité :</label>
