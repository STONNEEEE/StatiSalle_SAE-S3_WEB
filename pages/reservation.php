        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <!--TODO Faire une liste déroulante avec une fonction php qui récupère les salles correspondantes -->
                    <label for="noTel" class="<?php //echo $classnoTel; ?>">Nom de la salle :</label>
...
//                        }
            ...
            <div class="row">
                <div class="form-group offset-2 col-4">
                    ...
                    <label for="noTel" class="<?php //echo $classnoTel; ?>">Activité :</label>
...
//            $dt = new DateTime();
            ...
            <div class="row">
                <div class="form-group offset-2 col-2">
                    ...
                    <input type="date" name="date" placeholder="Choisir la date de votre réservation" class="form-control" value="" min="" required>
                </div>
        ...
        <br>
        <!-- TODO Faire n esorte que le bouton soit cliquable quand les infos obligatoires sont rentrées -->
        <div class="col-3 offset-9">
            <button type="submit" class="btn btn-primary btn-block" id="submit">Réserver</button>
        <br><br>
        </div>
        <!-- Footer de la page -->
