            ...
            <div class="row d-flex justify-content-center align-items-start w-100 mb-5">
                <div class="acc-container p-4 w-50">
                    <p>
                        ...
                        <br>
                        Si une salle est déjà réservée et que vous tentez de la modifier un pop up apparaitra demandant si vous voulez annuler ou confirmer. Si vous annulez vous serez redirigé vers la liste des réservations si vous confirmez la modification est effectuée.
                    </p>
                </div>
            </div>
        </div>
