...
<head>
    <meta charset="UTF-8">
    <title>StatiSalle - aides création d'un employé</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="full-screen padding-header">
        ...
        <div class="row d-flex justify-content-center align-items-start w-100 mb-5">
            <div class="acc-container p-4 w-50">
                ...
                <p>
                    Après, il y a les champs non obligatoires qui sont les champs qui concerne le nombre d’ordinateurs présent dans la salle le type de matériel qu’il peut y avoir dans la salle comme des pc portable par exemple. Il y a aussi les logiciels que le matériel peut contenir dans la salle et s'il y a une imprimante ou non.
                </p>
